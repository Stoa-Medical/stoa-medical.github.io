<main>
    ...
    <p>
        ...
        <br>
        Right now, we're [bootstrapping](https://en.wikipedia.org/wiki/Bootstrapping#Business) and [a team of one](https://www.linkedin.com/in/ericpan64/), please reach-out if you'd like to connect!
    </p>
</main>